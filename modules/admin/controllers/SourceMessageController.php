...
*/
class SourceMessageController extends \yii\web\Controller
{
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        ...
                        'roles' => ['AppSourceMessageFull'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['index', 'view'],
                        'roles' => ['AppSourceMessageView'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['update', 'create', 'delete'],
                        'roles' => ['AppSourceMessageEdit'],
                    ],
                ],
            ],
        ];
    ...
    * If creation is successful, the browser will be redirected to the 'view' page.
    ...
    public function actionCreate(int $id = null)
    {
        ...
        if ($id) {
            $originModel = SourceMessage::findOne($id);
