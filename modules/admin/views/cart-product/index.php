...
$this->title = Yii::t('models', 'Cart Products');
...
if (\Yii::$app->user->can('app_cart-product_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('app_cart-product_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('app_cart-product_delete', ['route' => true])) {
...
<div class="cart-product-index">
    ...
    <h1>
        <?= Yii::t('models', 'Cart Products') ?>
        <small>
            <?= Yii::t('cruds', 'List') ?>        </small>
    </h1>

    <div class="clearfix crud-navigation">
		<?php if(\Yii::$app->user->can('app_cart-product_create', ['route' => true])): ?>
            <div class="pull-left">
                <?= Html::a(
                    Yii::t('cruds', 'New'), 
                    ['create'], 
        ...
        <?= GridView::widget([
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->cart) {
			            return Html::a($rel->label, ['cart/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
