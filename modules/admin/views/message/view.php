...
$this->params['breadcrumbs'][] = ['label' => Yii::t('models', 'Messages'), 'url' => ['index']];
...
[
    ...
    'attribute' => 'source_id',
    'value' => ($model->source ? 
        Html::a('<i class="glyphicon glyphicon-list"></i>', ['source-message/index']).' '.
        Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->source->label, ['source-message/view', 'id' => $model->source->id,]).' '.
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'Message'=>['source_id' => $model->source_id]])
        : 
