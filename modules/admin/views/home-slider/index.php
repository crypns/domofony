...
* @var app\models\search\HomeSlider $searchModel
*/

$this->title = Yii::t('models', 'Home Sliders');
...
if (\Yii::$app->user->can('app_home-slider_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
}

if (\Yii::$app->user->can('app_home-slider_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
}

if (\Yii::$app->user->can('app_home-slider_delete', ['route' => true])) {
...
<div class="home-slider-index">
    ...
    <h1>
        <?= Yii::t('models', 'Home Sliders') ?>
        <small>
            <?= Yii::t('cruds', 'List') ?>        </small>
    </h1>

    <div class="clearfix crud-navigation">
		<?php if(\Yii::$app->user->can('app_home-slider_create', ['route' => true])): ?>
            <div class="pull-left">
                <?= Html::a(
                    Yii::t('cruds', 'New'), 
                    ['create'], 
