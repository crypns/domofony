...
<div class="order_block df dn" id="order_block">
  ...
  <section class="house">
    <div class="block">
      <div class="address">
        <h1>Сирецькі сади</h1>
        <p class="p1">м. Київ, вул. Івана Виговського, 10Д</p>
      </div>
      <div class="description">
        <p class="p1">Текстовий опис ЖК. В декілька рядків.</p>
        <p class="p1">Домофон можно запитать от 12В либо же по PoE. Домофон доступен в белом цвете корпуса.</p>
      </div>
    </div>
  </section>
  ...
  <section class="banner solitary">
    <div class="block">
      <div class="slider">
        <div class="item">
          <div class="text">
            <h2>Безконтактний дверний дзвінок</h2>
            <h5>SH-46T</h5>
            <a href="#">
          ...
          <div class="img">
              <img src="<?= Yii::getAlias('@web/img/banner.jpg') ?>" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="goods" id="goods">
    <div class="block">
      <div class="head">
        <h6>Товари для ЖК Сирецькі сади</h6>
        <div class="cart">
      ...
      <div class="item">
        <div class="object">
          ...
          <div class="name">
            <h6>Відеокамера Hickvision DS-2CELJHK (2.8 mm)</h6>
          </div>
        </div>
