...
/**
* This is the class for REST controller "PopularProductController".
*/
use yii\filters\AccessControl;

use app\models\PopularProduct;

class PopularProductController extends \app\custom\BaseApiController
{
    public $modelClass = PopularProduct::class;
