...
/**
* This is the class for REST controller "YoutubeSliderController".
*/
use yii\filters\AccessControl;

use app\models\YoutubeSlider;

class YoutubeSliderController extends \app\custom\BaseApiController
{
    public $modelClass = YoutubeSlider::class;
