...
/**
* This is the class for REST controller "ComplexProductController".
*/
use yii\filters\AccessControl;

use app\models\ComplexProduct;

class ComplexProductController extends \app\custom\BaseApiController
{
    public $modelClass = ComplexProduct::class;
