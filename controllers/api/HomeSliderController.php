...
/**
* This is the class for REST controller "HomeSliderController".
*/
use yii\filters\AccessControl;

use app\models\HomeSlider;

class HomeSliderController extends \app\custom\BaseApiController
{
    public $modelClass = HomeSlider::class;
