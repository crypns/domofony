...
/**
* This is the class for REST controller "CartProductController".
*/
use yii\filters\AccessControl;

use app\models\CartProduct;

class CartProductController extends \app\custom\BaseApiController
{
    public $modelClass = CartProduct::class;
