...
/**
* This is the class for REST controller "ApartmentComplexController".
*/
use yii\filters\AccessControl;

use app\models\ApartmentComplex;

class ApartmentComplexController extends \app\custom\BaseApiController
{
    public $modelClass = ApartmentComplex::class;
